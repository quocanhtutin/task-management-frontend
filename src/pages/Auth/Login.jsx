    ...
    try {
      ...
      if (data.accessToken) {
        ...
        if (returnUrl) {
         ...
         alert('Đăng nhập thành công nhưng server không trả về Token!');
      }
    } catch (error) {
      console.error(error);
      ...
      <div className="login-box">
        ...
        <div className="social-login">
          <GoogleOAuthProvider clientId="1079952925292-374ad5i80lfacs983o0apitqaib68k38.apps.googleusercontent.com">
            <GoogleLogin 
              onSuccess={(res) => performLogin({ type: "Google", token: res.credential })} 
              theme="filled_blue" 
              width="340" 
            />
          </GoogleOAuthProvider>
          ...
          <FacebookLogin
            ...
            render={p => (
              <button onClick={p.onClick} className="btn-facebook" disabled={isLoading}>
